...
\includegraphics[width=0.5\textwidth]{../code/figures/result-x-[1.5, 2, 2.5, 50][10, 10, 10, 10].pdf}
\includegraphics[width=0.5\textwidth]{../code/figures/error-x-[1.5, 2, 2.5, 50][10, 10, 10, 10].pdf}
% \includegraphics[width=0.5\textwidth]{../code/figures/result-y-[2, 2, 2][10, 100, 1000].pdf}
% \includegraphics[width=0.5\textwidth]{../code/figures/error-y-[2, 2, 2][10, 100, 1000].pdf}
